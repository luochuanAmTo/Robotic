...
# on remote
data_paths="/hy-tmp/dataset/rec_jsons_internvl/select_var_train.jsonl:/hy-tmp/dataset/rec_jsons_internvl/refcoco_train.jsonl"
image_folders="/hy-tmp/dataset:/hy-tmp/dataset"
